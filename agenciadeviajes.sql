...
INSERT INTO `testimonios` VALUES (1,'Miguel Hombre Gonz├ílez Sim├│n','miguelgs.mg91@gmail.com','aaa'),(2,'aaaa','miguelgs.mg91@gmail.com','bbbb'),(3,'bbbb','miguelgs.mg91@gmail.com','cccc'),(4,'Miguel Hombre Gonz├ílez Sim├│n','miguelgs.mg91@gmail.com','dsfadfasfasfasf');
...
CREATE TABLE `viajes` (
  ...
  `disponibles` varchar(3) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2019-08-19 18:48:34
